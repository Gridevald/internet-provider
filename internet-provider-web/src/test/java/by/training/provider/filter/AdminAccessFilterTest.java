...
public class AdminAccessFilterTest {
    ...
    private static final String CONTEXT = "gigabit/admin";
    @Mock
    ...
    @Test
    public void shouldChainDoFilterWhenRoleIsAdmin() throws IOException, ServletException {
    ...
    @Test
    public void shouldSendRedirectWhenRoleIsNotAdmin() throws IOException, ServletException {
